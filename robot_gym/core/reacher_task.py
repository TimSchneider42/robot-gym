from robot_gym.environment.simulation import SimulationObject, ShapeTypes
import math
from typing import Tuple, Dict, Optional
import numpy as np

from .controllers import JointVelocityController
from transformation import Transformation
from .rewards import ActionReward, ReacherReward
from .sensors.robot import ArmJointSinCosSensor, ArmJointVelocitySensor
from .simulated_task import SimulatedTask


class ReacherTask(SimulatedTask):
    """
    ...
    def __init__(self, time_step: float = 0.005, initial_position_var: float = 0.2,
        ...
        """
        controllers = [JointVelocityController("ur10", "arm")]
        sensors = [ArmJointSinCosSensor("ur10"), ArmJointVelocitySensor("ur10")]
        reward = 1e-3 * ActionReward() + ReacherReward("ur10")
        super(ReacherTask, self).__init__(controllers, sensors, reward, time_step, time_limit_steps=time_limit_steps)
